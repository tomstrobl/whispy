...
class NAFC(_BaseUIWindow):
    ...
    def _build_ui(self) -> None:
        ...
        # The stretches (here and below the choice buttons) center the choice
        # buttons between the task text pinned on top and the submit button +
        ...
        # submit button (disabled until a choice is selected), pinned to the
